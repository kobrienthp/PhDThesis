...
Within the ground state manifold, the spin model may be replaced by a model of hardcore dimers which occupy the bonds of the honeycomb lattice.
...
\begin{figure}[tb]
	\centering
	\includegraphics[width=0.7\linewidth]{./chapter07/HoneycombFiniteTempSpinSpinCorrelations.pdf}
	\caption{
...
\begin{figure}[tb]
	\centering
	\includegraphics[width=0.7\linewidth]{./chapter07/HoneycombDispersion.pdf}
	\caption{
